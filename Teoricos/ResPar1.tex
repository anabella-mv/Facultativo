...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \end{gather*}
        Al tener 1 en el numerador podemos reescribir esta fracción como el inverso de su numerador, es decir, $\frac{1}{\frac{a}{b}}=\frac{b}{a}$, para que podamos entender como funciona basta pensar en como se trabaja con la división cuando el divisor es fraccionario: $\frac{1}{\frac{a}{b}}= 1 : \frac{a}{b}=1 \cdot \frac{b}{a}=\frac{b}{a}$       
        \begin{gather*}
